          ...
          <div className="bg-[#251a0e] h-[600px] rounded-xl p-6 space-y-8">
            <div className="text-center">
              ...
              <p className=" mt-2 text-[15px]">
                <span className="mr-[8px]">Olá,</span>
            ...
            <div className="flex flex-col items-center gap-4 mt-[30px]">
              <div className="relative">
                <img
                  src={image || user.profilePic || reactImage}
                  className="size-38 rounded-full object-cover border-3"
                  alt="perfil"
                />
                <label
            ...
            `}
              ...
              <div>
                <p className="text-[13px] mt-10 ml-1">Nome Completo</p>
                <input
                  type="text"
                  value={user.fullname}
                  className="w-[400px] 
             ...
             mt-[4px]  rounded-[8px] h-10"
              ...
              <div>
                <p className="text-[13px] ml-1 mt-[7px]">Email</p>
                <input
                  value={user.email}
                  placeholder="Email"
                  className="w-[400px] 
